...
public class Sonic {
    ...
    public static void play(final File file, final float speed, final float pitch, final float volume) throws LineUnavailableException, IOException, UnsupportedAudioFileException {
        ...
        play(stream, speed, pitch, volume);
    }

    public static void play(final AudioInputStream stream, final float speed, final float pitch, final float volume) throws LineUnavailableException {
